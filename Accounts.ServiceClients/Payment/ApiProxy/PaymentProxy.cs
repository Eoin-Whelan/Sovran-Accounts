...
namespace AccountService.ServiceClients.Payment.ApiProxy
{
    ...
    public partial class PaymentProxy : IPaymentProxy
    {
        ...
        public PaymentProxy(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
    ...
    public partial class PaymentRegistrationResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("stripeAccountNo", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
